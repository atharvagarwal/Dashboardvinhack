    ...
    <div className="bg-gray-100 p-3 w-1/4">
      <div className="w-96 mx-auto" style={{scrollSnapType: 'x mandatory'}}>
        ...
        <div className>
          ...
          {/* content #1 */}
          <div className="w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100  z-0">
            <img className="rounded-t-lg w-3/4 h-64" src="https://images.unsplash.com/photo-1628788835388-415ee2fa9576?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=384&q=80" alt="" />
            ...
            {/* controls */}
            <div className="absolute top-1/2 w-full flex justify-between z-0">
